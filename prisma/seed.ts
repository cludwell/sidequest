          ...
          create: [
            {
              ...
              appearance:
                "Tall and thin, with dark hair and piercing green eyes.",
...
async function seedScenarios() {
  try {
    ...
    The Unseen Threat: Behind the allure and enchantment of the Feywild l ies an unseen threat, an ancient malevolence that seeks to exploit the mystical energy of the forest for nefarious purposes. Unraveling this threat becomes essential to restoring the balance between the mortal realm and the Feywild.`,
