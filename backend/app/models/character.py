...
class Character(db.Model):
    ...
    armor = db.Column(db.ARRAY(db.String), nullable=True)
    equipped = db.Column(db.ARRAY(db.String), nullable=True)
    inventory = db.Column(db.ARRAY(db.String), nullable=True)
    languages = db.Column(db.ARRAY(db.String), nullable=True)
    spells = db.Column(db.ARRAY(db.String), nullable=True)
    tools = db.Column(db.ARRAY(db.String), nullable=True)
    weapons = db.Column(db.ARRAY(db.String), nullable=True)
